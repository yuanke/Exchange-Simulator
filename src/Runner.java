 ...
 * 
 * @author QIAN HU
 * This class should replay the supplied iterator and after processing very message should
 * print the top of the book. Also, in case of a trade, you should print a line in the
 * following format "Order xxx traded with order yyy" where xxx, and yyy are the order ids.
 *
 */
public class Runner {
	...
	public void processMessage(IMessage m){
		...
		printTop();  // Print the top of books after processing a message.
	}
	...
	/**
	 * This method can print the top of ask-book and bid-book after processing a message.
	 */
	public void printTop(){
		if(!askBooks.isEmpty()){
			for(String st: askBooks.keySet()){
				System.out.println(st);
				System.out.println("Ask: " );
				askBooks.get(st).printAskTop();
				System.out.println("Bid: " );
				bidBooks.get(st).printBidTop();
				System.out.println("-----------------------------------------------------------------");
			}
		}		
	}
